...
def get_p(
            ...
            unsafe_div(
                unsafe_mul(
                    ...
                    unsafe_add(
                        ...
                        unsafe_div(
                            unsafe_mul(
                                unsafe_div(unsafe_div(unsafe_mul(10**18*9, A), 27), 10000),
                                gamma
                            ),
                            10**18
                        )
    ...
    )  # <--- We do 81*(10**18 + gamma*(2*10**18 + gamma + 10**18*9*A/27/10000*gamma/10**18)/10**18)
    #  unsafely here, since this is safe to do.
    s2 = unsafe_div(
